...
int flag;
int timer;
// 2nd position variable, holds the new requested position
int rainflag;                                                                     // a flag used to cycle between 3 running states - "forward-moving", "backwards-moving", and "off"
